    ...
    <div>
      <div className="bg-slate-100 p-3">
        <Image
          ...
          priority={true}
        />
        <h1 className="text-center mb-1 text-2xl md:text-3xl xl:text-4xl md:leading-normal text-primary font-semibold px-5">
          Layanan HAKI
        </h1>
        <h1 className="text-center text-2xl md:text-3xl xl:text-4xl md:leading-normal text-primary font-semibold px-5 lg:mt-4">
        ...
        <div className=" container pt-5 pb-8">
          ...
          <div className="flex flex-col gap-3">
            <h1 className=" text-justify bg-white py-2 px-5 tracking-wide leading-normal text-slate-700 md:text-lg md:p-5  lg:text-xl md:leading-normal xl:leading-relaxed  ">
              <span className="font-bold">Layanan Pengecekan Merek </span>:
              untuk mengetahui peluang atas pendaftaran merek
            </h1>
            <div className="bg-white py-2 px-5 md:p-5 ">
